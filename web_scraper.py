...
til_arrays = [['Bolton Wanderers', 'Salford City', 'Cheltenham Town', 'Exeter City', 'Cambridge United', 'Morecambe', 'Leyton Orient', 'Tranmere Rovers', 'Oldham Athletic', 'Stevenage', 'Port Vale', 'Carlisle United', 'Forest Green Rovers', 'Bradford City', 'Scunthorpe United', 'Crawley Town', 'Colchester United', 'Newport County', 'Mansfield Town', 'Harrogate Town', 'Walsall', 'Barrow', 'Southend United', 'Grimsby Town'], ['Hull City', 'Peterborough United', 'Sunderland', 'Portsmouth', 'Charlton Athletic', 'Ipswich Town', 'Oxford United', 'Blackpool', 'Fleetwood Town', 'Lincoln City', 'Doncaster Rovers', 'Burton Albion', 'Milton Keynes Dons', 'Shrewsbury Town', 'Crewe Alexandra', 'Accrington Stanley', 'Gillingham', 'Plymouth Argyle', 'Wigan Athletic', 'Bristol Rovers', 'AFC Wimbledon', 'Swindon Town', 'Northampton Town', 'Rochdale'], ['AFC Bournemouth', 'Barnsley', 'Birmingham City', 'Blackburn Rovers', 'Brentford', 'Bristol City', 'Cardiff City', 'Coventry City', 'Derby County', 'Huddersfield Town', 'Luton Town', 'Middlesbrough', 'Millwall', 'Norwich City', 'Nottingham Forest', 'Preston North End', 'Queens Park Rangers', 'Reading', 'Rotherham United', 'Sheffield Wednesday', 'Stoke City', 'Swansea City', 'Watford', 'Wycombe Wanderers'], ['Arsenal','Aston Villa','Brighton & Hove Albion','Burnley','Chelsea','Crystal Palace','Everton','Fulham','Leeds United','Leicester City','Liverpool','Manchester City','Manchester United','Newcastle United','Sheffield United','Southampton','Tottenham Hotspur','West Bromwich Albion','West Ham United','Wolverhampton Wanderers']]
tfi_dictionaries = [{'Bolton Wanderers': '4', 'Salford City': '113926', 'Cheltenham Town': '1936', 'Exeter City': '143', 'Cambridge United': '1944', 'Morecambe': '357', 'Leyton Orient': '1958', 'Tranmere Rovers': '15048', 'Oldham Athletic': '1920', 'Stevenage': '361', 'Port Vale': '1928', 'Carlisle United': '1480', 'Forest Green Rovers': '561', 'Bradford City': '1804', 'Scunthorpe United': '1949', 'Crawley Town': '110890', 'Colchester United': '1935', 'Newport County': '112254', 'Mansfield Town': '1940', 'Harrogate Town': '112222', 'Walsall': '1803', 'Barrow': '381', 'Southend United': '1954', 'Grimsby Town': '92'}, {'Hull City': '1952', 'Peterborough United': '1938', 'Sunderland': '106', 'Portsmouth': '1790', 'Charlton Athletic': '89', 'Ipswich Town': '94', 'Oxford United': '1951', 'Blackpool': '1926', 'Fleetwood Town': '112260', 'Lincoln City': '149', 'Doncaster Rovers': '142', 'Burton Albion': '15015', 'Milton Keynes Dons': '1798', 'Shrewsbury Town': '127', 'Crewe Alexandra': '121', 'Accrington Stanley': '110313', 'Gillingham': '1802', 'Plymouth Argyle': '1929', 'Wigan Athletic': '1917', 'Bristol Rovers': '1962', 'AFC Wimbledon': '112259', 'Swindon Town': '1934', 'Northampton Town': '1930', 'Rochdale': '1955'}, {'AFC Bournemouth': '1943', 'Barnsley': '1932', 'Birmingham City': '88', 'Blackburn Rovers': '3', 'Brentford': '1925', 'Bristol City': '1919', 'Cardiff City': '1961', 'Coventry City': '1800', 'Derby County': '91', 'Huddersfield Town': '1939', 'Luton Town': '1923', 'Middlesbrough': '12', 'Millwall': '97', 'Norwich City': '1792', 'Nottingham Forest': '14', 'Preston North End': '1801', 'Queens Park Rangers': '15', 'Reading': '1793', 'Rotherham United': '1797', 'Sheffield Wednesday': '1807', 'Stoke City': '1806', 'Swansea City': '1960', 'Watford': '1795', 'Wycombe Wanderers': '1933'}, {'Arsenal': '1', 'Aston Villa': '2', 'Brighton & Hove Albion': '1808', 'Burnley': '1796', 'Chelsea': '5', 'Crystal Palace': '1799', 'Everton': '7', 'Fulham': '144', 'Leeds United': '8', 'Leicester City': '95', 'Liverpool': '9', 'Manchester City': '10', 'Manchester United': '11', 'Newcastle United': '13', 'Sheffield United': '1794', 'Southampton': '17', 'Tottenham Hotspur': '18', 'West Bromwich Albion': '109', 'West Ham United': '19', 'Wolverhampton Wanderers': '110'}]
league_indxes = ['61', '60', '14', '13']
...
current_days_until_next_dev_update = 0
...
def figure_out_development(age, rating, player_pot, date_of_birth, next_to_one, player_stats, position) :
    rating_value_change, counting_days_array = determine_rating_value_change(age, rating, player_pot, date_of_birth, next_to_one)
            
    player_stats_trying, player_pos_trying = player_stats, position
    ...
    counting_days_array2, days_after_age = player_decay(age_spitting_in, date_of_birth, player_pot, mod)

    
    final_development_plan2 = {stat_name:[] for stat_name in player_stats_trying}
    
    broke = False
    
    for i, counted_days in enumerate(counting_days_array2) :
        counted_days = 100
        try :
        ...
        for key_trying_stats in trying_stats :
            if i == 0 :
                final_development_plan2[key_trying_stats].append(0)
            else :
                final_development_plan2[key_trying_stats].append((trying_stats[key_trying_stats]-player_stats_trying[key_trying_stats])/counted_days)
    ...
    if broke :
        for key_fdp in final_development_plan2 :
            still_to_do = len(counting_days_array2)-len(final_development_plan2[key_fdp])
            for std in range(still_to_do) :
                final_development_plan2[key_fdp].append(None)
    
    if empty_cda :
        for key_fdp in final_development_plan2 :
            final_development_plan2[key_fdp] = final_development_plan2[key_fdp][1:]
        counting_days_array2 = counting_days_array2[1:]
    
    days_until_thirty = 10950-((age_spitting_in*365))
    if days_until_thirty > 0 :
        for key_dev2 in final_development_plan2 :
            final_development_plan2[key_dev2].insert(0, 0)
        counting_days_array2.insert(0, days_until_thirty)
    return final_development_plan, counting_days_array, final_development_plan2, counting_days_array2, days_after_age

for operation_index in range(4) :
    teams_in_league = til_arrays[operation_index]
    league_page = scrape('https://www.fifaindex.com/teams/fifa21_486/?league='+league_indxes[operation_index])
    ...
    for team_in_league in teams_in_league :
        ...
        player_links = ['https://www.fifaindex.com'+li[6:]+'/'+'fifa21/' for li in list(set(re.findall('href=\"/player/[0-9]+', soup)))]
        final_dict = {}
        for player_link in player_links :
            ...
            final_development_plan, counting_days_array, final_development_plan2, counting_days_array2, daa = figure_out_development(age, rating, player_pot, player_data['Date of Birth'], player_data['NextToOne'], player_data['Player Stats'], player_data['Position'])
            ...
            player_progress_bday = player_data['Date of Birth'].split(',')[0].split(' ')
            player_progress_bday = convert_shortened[player_progress_bday[0]]+' '+ player_progress_bday[1]
            player_data['Date of Birth'] = player_progress_bday
            player_data['Bases'] = {}
            for name_of_stat in player_data['DevelopmentPlan2'] :
                for ffnz_index, find_first_non_zero in enumerate(player_data['DevelopmentPlan2'][name_of_stat]) :
                    if find_first_non_zero != 0 :
                        basis = (find_first_non_zero)*player_data['DevelopmentPlanCountedDaysArray2'][ffnz_index]
                        player_data['Bases'][name_of_stat] = basis
                        break
                        
            current_days_until_next_dev_update += 1
            if current_days_until_next_dev_update == 20 :
                current_days_until_next_dev_update = 0
            
            if player_data['Team'] == 'Bournemouth' :
                player_data['Team'] = 'AFC Bournemouth'
